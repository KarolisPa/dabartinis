...
<div class="rounded-xl shadow-xl border border-2 bg-gray-200 focus-within:bg-yellow-400 focus-within:border-yellow-700">
        ...
        <div  wire:ignore.self class="mySlides w-full h-auto ">
            ...
            <div class="grid grid-cols-3">
                @foreach($vartai as $vartasMasina)
                    <div  wire:click="$set('vartaiSelected', {{$vartasMasina->id}})" class="rounded-xl shadow-xl border border-2 bg-gray-200 m-5 focus-within:bg-yellow-400 focus-within:border-yellow-700">
        ...
        <div  wire:ignore.self class="mySlides w-full h-auto ">
            ...
            <div class="grid grid-cols-3">
                @foreach($tvoros as $tvora)
                    <div  wire:click="$set('tvoraSelected', {{$tvora->id}})" class="rounded-xl shadow-xl border border-2 bg-gray-200 m-5 focus-within:bg-yellow-400 focus-within:border-yellow-700">
        ...
        <div  wire:ignore.self class="mySlides w-full h-auto ">
            ...
            <div class="grid grid-cols-3">
                @foreach($boksteliai as $bokstelis)
                    <div  wire:click="$set('bokstelisSelected', {{$bokstelis->id}})" class="rounded-xl shadow-xl border border-2 bg-gray-200 m-5 focus-within:bg-yellow-400 focus-within:border-yellow-700">
