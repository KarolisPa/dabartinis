<div>
    <div x-data="{ show: @entangle('show') }" wire:target="toggle()" class="{{$border}} xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-blue-200 border-opacity-60">
        <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">Remonto darbai</h2>
        <p class="leading-relaxed text-base mb-4">Atliekame įvairius remonto darbus</p>
